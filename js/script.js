$(document).ready(function() {
    ...
    "use strict";
    //services tabs according
    $(".service-item-title").click(function() {
        var $content = $(this).next().children(".service-content");
        var $minus = $content.parent().prev().children("span");
        if ($content.css("display") == "none") {
            $(".service-content").slideUp(500)
            $(".service-item-title span").html("<i class='material-icons'>add_circle_outline</i>")
            $content.slideDown(500);
            $minus.html("<i class='material-icons'>remove_circle_outline</i>")
        } else {
            $content.slideUp(500);
            $minus.html("<i class='material-icons'>add_circle_outline</i>")
        }
    })
